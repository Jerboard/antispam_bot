...
def get_main_kb() -> InlineKeyboardMarkup:
    ...
    kb.button(text='➕ БС фраз', callback_data=f'{AdminCB.ADD_WL.value}:{ListEx.WL_PHRASE.value}')
    kb.button(text='➖ БС фраз', callback_data=f'{AdminCB.DEL_WL.value}:{ListEx.WL_PHRASE.value}')
